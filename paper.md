...
The accuracy of the core capabilites of pyshbundle was evaluated against the MATLAB software SHbundle. For more details please see the jupyter notebook `examples/validation_pyshbundle` and the corresponding python unit tests in `tests/`.
